...
impl TryFrom<ShapeBuilder> for HollowStructuralSection {
...
mod tests {
    ...
    fn builder_happy_path_works() {
        ...
        assert_eq!(String::from("HSS8X6X.500"), shape.edi_std_nomenclature);
        assert_eq!(String::from("HSS8X6X1/2"), shape.aisc_manual_label);
