...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .edi_std_nomenclature(String::from("HP12X84"))
            .aisc_manual_label(String::from("HP12X84"))
            .w_upper(84.0)
            .a_upper(24.6)
            .d_lower(12.3)
            .ddet(12.25)
        ...
        assert_eq!(12.25, shape.ddet);
        assert_eq!(12.3, shape.bf);
        assert_eq!(12.25, shape.bfdet);
        assert_eq!(0.685, shape.tw);
        assert_eq!(0.6875, shape.twdet);
        assert_eq!(0.375, shape.twdet_2);
        assert_eq!(0.685, shape.tf);
        assert_eq!(0.6875, shape.tfdet);
        assert_eq!(1.38, shape.kdes);
        assert_eq!(1.5625, shape.kdet);
        assert_eq!(1.1875, shape.k1);
        assert_eq!(8.97, shape.bf_2tf);
        assert_eq!(14.2, shape.h_tw);
        assert_eq!(650.0, shape.ix);
        assert_eq!(120.0, shape.zx);
        assert_eq!(106.0, shape.sx);
        assert_eq!(5.14, shape.rx);
        assert_eq!(213.0, shape.iy);
        assert_eq!(53.2, shape.zy);
        assert_eq!(34.6, shape.sy);
        assert_eq!(2.94, shape.ry);
        assert_eq!(4.24, shape.j_upper);
        assert_eq!(7140.0, shape.cw);
        assert_eq!(35.6, shape.wno);
        assert_eq!(75.0, shape.sw1);
        assert_eq!(23.1, shape.qf);
        assert_eq!(59.0, shape.qw);
        assert_eq!(3.14, shape.rts);
        assert_eq!(11.6, shape.ho);
        assert_eq!(3.41, shape.pa);
        assert_eq!(71.4, shape.pb);
        assert_eq!(36.9, shape.pc);
        assert_eq!(49.2, shape.pd);
        assert_eq!(9.5, shape.t);
        assert_eq!(5.5, shape.wgi);
    }
