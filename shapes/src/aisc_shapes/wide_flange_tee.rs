...
pub struct WideFlangeTee<'std_nom, 'aisc_label> {
...
impl<'std_nom, 'aisc_label> TryFrom<ShapeBuilder<'std_nom, 'aisc_label>>
    for WideFlangeTee<'std_nom, 'aisc_label>
{
...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .with_edi_std_nomenclature("WT12X31")
            .with_aisc_manual_label("WT12X31")
            .with_t_f(false)
            .with_w_upper(31.0)
            .with_a_upper(9.11)
            .with_d_lower(11.9)
        ...
        assert_eq!("WT12X31", shape.edi_std_nomenclature);
        assert_eq!("WT12X31", shape.aisc_manual_label);
        assert!(!shape.t_f);
