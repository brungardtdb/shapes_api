...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .edi_std_nomenclature(String::from("M12X10"))
            .aisc_manual_label(String::from("M12X10"))
            .t_f(false)
            .w_upper(10.0)
            .a_upper(2.95)
            .d_lower(12.0)
        ...
        assert_eq!(3.25, shape.bf);
        assert_eq!(3.25, shape.bfdet);
        assert_eq!(0.149, shape.tw);
        assert_eq!(0.125, shape.twdet);
        assert_eq!(0.0625, shape.twdet_2);
        assert_eq!(0.180, shape.tf);
        assert_eq!(0.1875, shape.tfdet);
        assert_eq!(0.5, shape.kdes);
        assert_eq!(0.5, shape.kdet);
        assert_eq!(0.375, shape.k1);
        assert_eq!(9.03, shape.bf_2tf);
        assert_eq!(74.7, shape.h_tw);
        assert_eq!(61.7, shape.ix);
        assert_eq!(12.2, shape.zx);
        assert_eq!(10.3, shape.sx);
        assert_eq!(4.57, shape.rx);
        assert_eq!(1.03, shape.iy);
        assert_eq!(1.02, shape.zy);
        assert_eq!(0.636, shape.sy);
        assert_eq!(0.592, shape.ry);
        assert_eq!(0.0292, shape.j_upper);
        assert_eq!(35.9, shape.cw);
        assert_eq!(9.6, shape.wno);
        assert_eq!(1.40, shape.sw1);
        assert_eq!(1.65, shape.qf);
        assert_eq!(5.98, shape.qw);
        assert_eq!(0.768, shape.rts);
        assert_eq!(11.8, shape.ho);
        assert_eq!(33.0, shape.pa);
        assert_eq!(36.2, shape.pb);
        assert_eq!(27.2, shape.pc);
        assert_eq!(30.4, shape.pd);
        assert_eq!(11.0, shape.t);
    }
