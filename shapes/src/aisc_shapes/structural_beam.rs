...
pub struct StructuralBeam<'std_nom, 'aisc_label> {
...
impl<'std_nom, 'aisc_label> TryFrom<ShapeBuilder<'std_nom, 'aisc_label>>
    for StructuralBeam<'std_nom, 'aisc_label>
{
...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .with_edi_std_nomenclature("S12X31.8")
            .with_aisc_manual_label("S12X31.8")
            .with_w_upper(31.8)
            .with_a_upper(9.31)
            .with_d_lower(12.0)
            .with_ddet(12.0)
        ...
        assert_eq!("S12X31.8", shape.edi_std_nomenclature);
        assert_eq!("S12X31.8", shape.aisc_manual_label);
