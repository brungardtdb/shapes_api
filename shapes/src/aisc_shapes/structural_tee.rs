...
#[derive(Debug)]
#[allow(dead_code)]
/// A struct that models the data for structural tee (ST) steel profiles
pub struct StructuralTee {
...
impl TryFrom<ShapeBuilder> for StructuralTee {
...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .with_edi_std_nomenclature(String::from("ST6X20.4"))
            .with_aisc_manual_label(String::from("ST6X20.4"))
            .with_w_upper(20.4)
            .with_a_upper(5.96)
            .with_d_lower(6.00)
            .with_ddet(6.00)
            ...
            .with_h_upper(0.732)
            .with_wgi(3.0)
            .try_build::<StructuralTee>();

        assert!(shape_result.is_ok());
        let shape = shape_result.unwrap();
        assert_eq!(String::from("ST6X20.4"), shape.edi_std_nomenclature);
        assert_eq!(String::from("ST6X20.4"), shape.aisc_manual_label);
        assert_eq!(20.4, shape.w_upper);
        assert_eq!(5.96, shape.a_upper);
        assert_eq!(6.00, shape.d_lower);
        assert_eq!(6.00, shape.ddet);
        assert_eq!(5.25, shape.bf);
        assert_eq!(5.25, shape.bfdet);
        assert_eq!(0.462, shape.tw);
        assert_eq!(0.4375, shape.twdet);
        assert_eq!(0.25, shape.twdet_2);
        assert_eq!(0.659, shape.tf);
        assert_eq!(0.6875, shape.tfdet);
        assert_eq!(1.44, shape.kdes);
        assert_eq!(1.4375, shape.kdet);
        assert_eq!(1.58, shape.y_lower);
        assert_eq!(0.577, shape.yp);
        assert_eq!(3.98, shape.bf_2tf);
        assert_eq!(13.0, shape.d_t);
        assert_eq!(18.9, shape.ix);
        assert_eq!(7.71, shape.zx);
        assert_eq!(4.27, shape.sx);
        assert_eq!(1.78, shape.rx);
        assert_eq!(6.74, shape.iy);
        assert_eq!(4.43, shape.zy);
        assert_eq!(2.57, shape.sy);
        assert_eq!(1.00, shape.ry);
        assert_eq!(0.842, shape.j_upper);
        assert_eq!(0.787, shape.cw);
        assert_eq!(2.42, shape.ro);
        assert_eq!(0.732, shape.h_upper);
