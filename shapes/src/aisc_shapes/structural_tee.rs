...
pub struct StructuralTee<'std_nom, 'aisc_label> {
...
impl<'std_nom, 'aisc_label> TryFrom<ShapeBuilder<'std_nom, 'aisc_label>>
    for StructuralTee<'std_nom, 'aisc_label>
{
...
mod tests {
    ...
    fn builder_happy_path_works() {
        let shape_result = ShapeBuilder::new()
            .with_edi_std_nomenclature("ST6X20.4")
            .with_aisc_manual_label("ST6X20.4")
            .with_w_upper(20.4)
            .with_a_upper(5.96)
            .with_d_lower(6.00)
            .with_ddet(6.00)
        ...
        assert_eq!("ST6X20.4", shape.edi_std_nomenclature);
        assert_eq!("ST6X20.4", shape.aisc_manual_label);
