...
pub mod tests {
    ...
    fn hss_8x6x500() -> HSS {
        ShapeBuilder::new()
            .with_edi_std_nomenclature(String::from("HSS8X6X.500"))
            .with_aisc_manual_label(String::from("HSS8X6X1/2"))
            .with_w_upper(42.05)
            .with_a_upper(11.6)
            .with_ht(8.0)
            .with_h(6.6)
    ...
    fn hss_8x8x500() -> HSS {
        ShapeBuilder::new()
            .with_edi_std_nomenclature(String::from("HSS8X8X.500"))
            .with_aisc_manual_label(String::from("HSS8X8X1/2"))
            .with_w_upper(48.85)
            .with_a_upper(13.5)
            .with_ht(8.0)
            .with_h(6.6)
    ...
    fn hss_6x6x500() -> HSS {
        ShapeBuilder::new()
            .with_edi_std_nomenclature(String::from("HSS6X6X.500"))
            .with_aisc_manual_label(String::from("HSS6X6X1/2"))
            .with_w_upper(35.24)
            .with_a_upper(9.74)
            .with_ht(6.0)
            .with_h(4.61)
