...
pub mod tests {
    ...
    fn double_l8x6x1llbb() -> DE {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("2L8X6X1LLBB"))
            .aisc_manual_label(String::from("2L8X6X1LLBB"))
            .w_upper(88.4)
            .a_upper(26.2)
            .d_lower(8.0)
            .b_lower(6.0)
    ...
    fn double_l10x10x1_3_8() -> DE {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("2L10X10X1-3/8"))
            .aisc_manual_label(String::from("2L10X10X1-3/8"))
            .w_upper(174.0)
            .a_upper(51.2)
            .d_lower(10.0)
            .b_lower(10.0)
    ...
    fn double_l12x12x1_3_8() -> DE {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("2L12X12X1-3/8"))
            .aisc_manual_label(String::from("2L12X12X1-3/8"))
            .w_upper(210.0)
            .a_upper(62.2)
            .d_lower(12.0)
            .b_lower(12.0)
    ...
    fn double_l8x8x1() -> DE {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("2L8X8X1"))
            .aisc_manual_label(String::from("2L8X8X1"))
            .w_upper(102.0)
            .a_upper(30.2)
            .d_lower(8.0)
            .b_lower(8.0)
