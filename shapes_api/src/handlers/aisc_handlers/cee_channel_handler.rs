...
pub mod tests {
    ...
    fn c8x13_75() -> C {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("C8X13.75"))
            .aisc_manual_label(String::from("C8X13.75"))
            .w_upper(13.75)
            .a_upper(4.03)
            .d_lower(8.0)
            .ddet(8.0)
    ...
    fn c8x11_5() -> C {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("C8X11.5"))
            .aisc_manual_label(String::from("C8X11.5"))
            .w_upper(11.5)
            .a_upper(3.37)
            .d_lower(8.0)
            .ddet(8.0)
    ...
    fn c7x14_75() -> C {
        ShapeBuilder::new()
            .edi_std_nomenclature(String::from("C7X14.75"))
            .aisc_manual_label(String::from("C7X14.75"))
            .w_upper(14.75)
            .a_upper(4.33)
            .d_lower(7.0)
            .ddet(7.0)
    ...
    async fn returns_shape_w_aisc_manual_label() {
        ...
        repo.expect_shape_with_aisc_manual_label()
            ...
            .returning(|_| Box::pin(async { Ok(Some(c7x14_75())) }));
    ...
    async fn filters_on_depth() {
        ...
        repo.expect_shapes_with_depth()
            ...
            .returning(|_| Box::pin(async { Ok(vec![c8x13_75(), c8x11_5()]) }));
    ...
    async fn filters_on_width() {
        ...
        repo.expect_shapes_with_width()
            ...
            .returning(|_| Box::pin(async { Ok(vec![c8x11_5(), c7x14_75()]) }));
