use serde::Serialize;
use shapes::aisc_shapes::CeeChannel as AISCCee;

/// A data transfer object for cee channel (C) steel profiles
...
impl From<&AISCCee> for CeeChannel {
    fn from(channel: &AISCCee) -> Self {
        CeeChannel {
            edi_std_nomenclature: channel.edi_std_nomenclature.clone(),
            aisc_manual_label: channel.aisc_manual_label.clone(),
            w_upper: channel.w_upper,
            a_upper: channel.a_upper,
            d_lower: channel.d_lower,
            ddet: channel.ddet,
            bf: channel.bf,
            bfdet: channel.bfdet,
            tw: channel.tw,
            twdet: channel.twdet,
            twdet_2: channel.twdet_2,
            tf: channel.tf,
            tfdet: channel.tfdet,
            kdes: channel.kdes,
            kdet: channel.kdet,
            x_lower: channel.x_lower,
            eo: channel.eo,
            xp: channel.xp,
            b_t: channel.b_t,
            h_tw: channel.h_tw,
